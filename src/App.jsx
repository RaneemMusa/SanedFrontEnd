...
// // Mock data for when Firebase is not configured yet
// const MOCK_SERVICES = [
//   {
//     id: "m1",
//     type: "offer",
...
//       <p>
//         &copy; {new Date().getFullYear()} Saned. Cyber Security Capstone
//         Project.
//       </p>
...
//   // After auth is ready, decide first page
//   useEffect(() => {
//     if (!loading) {
...
//   // Listen for services (or use mock if Firebase is not configured)
//   useEffect(() => {
//     if (db) {
...
//     // Guard: dashboard & post are only for logged-in users
//     if ((page === "dashboard" || page === "post") && !userId) {
...
//       <Header setPage={setPage} userId={userId} auth={auth} />
...
const App = () => {
  ...
  const renderPage = () => {
    ...
    // Guard: dashboard, post & profile are only for logged-in users
    if ((page === "dashboard" || page === "post" || page === "profile") && !userId) {
      return <AuthPage setPage={setPage} pageType="login" />;
    }
